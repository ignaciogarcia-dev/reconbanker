-- Register Mi Dinero extract_transactions v2.0.2 as the new active script.
-- Deprecates v2.0.1 (b2010000-0000-0000-0000-000000000001).
-- Code is loaded from disk by ScriptLoader:
--   src/contexts/script-engine/infrastructure/scripts/mi-dinero/extract_transactions.v2.0.2.js

-- Deprecate the previous active version first to satisfy uq_bank_script_active
UPDATE bank_scripts
SET status = 'deprecated'
WHERE id = 'b2010000-0000-0000-0000-000000000001'
  AND status = 'active';
